                    ...
                    <div class="card-body">
                        <div class="align-items-center">
                            <div class="d-flex align-items-start">
                                <img src="{{ Storage::url($user->profile) }}" onerror="this.onerror=null; this.src='{{ Vite::asset('resources/assets/images/default/avatar.jpg') }}';" class="rounded-2 avatar-xxl" alt="image profile">
                                <div class="overflow-hidden ms-4">
                                    <h4 class="m-0 text-dark fs-20">{{ $user->name }}</h4>
                                    <p class="my-1 text-muted fs-16">Người dùng</p>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <ol class="profile-section list-unstyled mb-0 px-4">
                                                ...
                                                <li class="profile-item">
                                                    <div class="avatar-sm profile-icon p-1">
                                                        <div class="avatar-title rounded-2 bg-light" style="height: 35px; width: 35px;">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 232">
                                                                ...
                                                                <path fill="#fdad00" d="M51.846 82.608L128 231.662l76.154-149.054z" />
                                                                <path fill="#fdd231" d="m55.855 7.628l-4.009 74.979L128 0zm148.298 74.98l-4.008-74.98L128 .001z" />
                                                                <path fill="#fdad00" d="M204.154 82.608h51.845l-55.854-74.98zM0 82.608h51.846l4.009-74.98z" />
                                                                <path fill="#feeeb7" d="M128 0L51.846 82.607h152.308z" />
                                                            </svg>
                                                        </div>
                                                    </div>
                                                    <div class="exper-item-list">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <ol class="profile-section list-unstyled mb-0 px-4">
                                                ...
                                                <li class="profile-item">
                                                    <div class="avatar-sm profile-icon p-1">
                                                        <div class="avatar-title rounded-2 bg-light" style="height: 35px; width: 35px;">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 275">
                                                                <path fill="#ff385c"
                                                    ...
                                                    <div class="avatar-sm profile-icon p-1">
                                                        <div class="avatar-title rounded-2 bg-light" style="height: 35px; width: 35px;">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256">
                                                                <path fill="#e74d89" d="M128 8.5c66 0 119.4 53.4 119.4 119.3S194 247.2 128 247.2S8.6 193.8 8.6 127.9S62 8.5 128 8.5" />
                                                                <path fill="#b2215a"
